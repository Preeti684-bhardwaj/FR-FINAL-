...
function get_next_qn() {
  ...
  var collectionss = "";
  var page6 =
    '<label class="QLable" id="Q2" style="color:green">total_questions2</label>';
  var collectionsss = "";
  $.ajax({
    url:
    ...
    success: function (data) {
      ...
      document.getElementById("inc").value =
        answered_questions + 1 + " of " + total_questions;
...
function submitanswer() {
  ...
  if (question_type == "single_choice") {
    if (choice_length == "4") {
      ...
      if (
        localStorage.getItem("key") == ids1 ||
        localStorage.getItem("key") == ids2 ||
        localStorage.getItem("key") == ids3 ||
        localStorage.getItem("key") == ids4
      ) {
...
function question1(data) {
  ...
  if (obj.choice.length == "4") {
    var page1 =
      ...
      '<li style="text-align: left;"><input type="radio" name="age" id="myBtn1" value="id1" onclick=" myFunction1()" class="btn btn-default" style="border : 1px solid red;width:25px;height:25px;margin-bottom : 1%;outline: none">&nbsp&nbsp<b style="color:#444444;font-size:14px"> answers <li>' +
    ...
    var page1 =
      ...
      '<div class="col-sm-12">' +
      '<ul class="list-group" style="list-style-type: none">' +
      '<li><input type="radio" name="age" id="myBtn1" value="id1" onclick=" myFunction1()" class="btn btn-default" style="border : 1px solid red;width:25px;height:25px;margin-bottom : 1%;outline: none">&nbsp&nbsp<b style="color:#444444;font-size:14px">answers<li>' +
      '<li style="display:none">id1</li>' +
      "</ul>" +
      "</div>" +
      '<div class="col-sm-12">' +
...
var imageAddr =
  "https://toyota-lakshya-onlineassessment.in/media/dealer_profile/68acb877-b4e2-4e43-8dd5-55fa8026d1a0.jpeg";
